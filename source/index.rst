...
.. toctree::
    :caption: Guia de instalação
    :maxdepth: 2

    rst/install.rst

.. toctree::
    :caption: Exemplos práticos
    :maxdepth: 2
...
.. toctree::
    :caption: API de rede neural clássica
    :maxdepth: 2
...
.. toctree::
    :caption: API QNN integrada com pyqpanda
    :maxdepth: 2
